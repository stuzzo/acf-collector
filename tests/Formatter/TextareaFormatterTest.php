...
use ACFCollector\Formatter\TextareaFormatter;
use ACFCollector\Tests\ACFCollectorTestCase;
use function file_get_contents;
use function json_decode;
use function sprintf;

class TextareaFormatterTest extends ACFCollectorTestCase
{
    private function getField(): array
    {
        $jsonFile = sprintf('%s/TextareaField.json', $this->jsonDir);
    ...
    public function testReturnValue(): void
    {
        ...
        $textarea = array_values($fieldFormatted);
        $this->assertIsString(reset($textarea));
    }
}