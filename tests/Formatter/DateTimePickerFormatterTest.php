...
use ACFCollector\Formatter\DateTimePickerFormatter;
use ACFCollector\Tests\ACFCollectorTestCase;
use function file_get_contents;
use function json_decode;
use function sprintf;

class DateTimePickerFormatterTest extends ACFCollectorTestCase
{
    private function getField(): array
    {
        $jsonFile = sprintf('%s/DateTimePickerField.json', $this->jsonDir);
