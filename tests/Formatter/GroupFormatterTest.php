...
use ACFCollector\Formatter\GroupFormatter;
use ACFCollector\Tests\ACFCollectorTestCase;
use function file_get_contents;
use function json_decode;
use function sprintf;

class GroupFormatterTest extends ACFCollectorTestCase
{
    private function getField(): array
    {
        $jsonFile = sprintf('%s/GroupField.json', $this->jsonDir);
    ...
    {
        $formatter = GroupFormatter::getInstance();
        $field = $this->getField();
